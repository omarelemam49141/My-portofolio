$(function () {
    ...
    $(window).load(function () {
        ...
        submitBtn.onclick = function () {
            ...
            if(name != '' && email != '' && message != '') {
                window.open('mailto:omarelemam49141@gmail.com?subject=' + email + '&body=' + message);
            }
        }
    }),
    ...
    e.on("click", function (o) {
        ...
        $(window).on("load resize", function () {
            document.getElementById('websites-btn').click();
            $(window).width() < 768 && (e.wrap('<div class="toggle-placeholder"></div>'), $(".toggle-placeholder").height(e.outerHeight()));
        }),
        $("#mix-container").mixItUp(),
        $(".lightbox-details").magnificPopup({ type: "inline", fixedContentPos: !1, removalDelay: 100, closeBtnInside: !0, preloader: !1, mainClass: "mfp-fade" }),
